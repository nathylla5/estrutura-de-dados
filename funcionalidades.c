...
void menuAtendente() {
    ...
    do {
        ...
        switch (opcao) {
            case 1:
                // A lógica para visualizar a fila de pedidos seria implementada aqui.
                printf("\nVisualizando fila de pedidos...\n");
                break;
            case 2:
                // A lógica para atualizar o status de um pedido seria implementada aqui.
